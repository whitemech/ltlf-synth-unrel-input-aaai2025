...
def run_test(test):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        if cordfa != 3:
            ...
            ltlf2foldir = "/data/coml-whitemech/some5590/synthesis-with-backup/product-construction/Syft/build/bin/" if CONSTANT_CLUSTER else os.path.join(Path.cwd(), "product-construction/Syft/build/bin/")
            ...
            main_dfa, backup_dfa = generate_dfas(ltlf2foldir, temp_dir, main_ltlf, backup_ltlf, cordfa)
            ...
            # Run the test
            try:
                SyftExecutableDir = "/data/coml-whitemech/some5590/synthesis-with-backup/product-construction/Syft/build/bin/" if CONSTANT_CLUSTER else os.path.join(Path.cwd(), "product-construction/Syft/build/bin/")
