...
std::string to_string (ltl_formula *root)
{
  ...
  else if (root->_type == eEXISTS)
    res = "(EX " + to_string(root->_left) + " " + to_string(root->_right) +")";
  else if (root->_type == eFORALL)
    res = "(ALL " + to_string(root->_left) + " " + to_string(root->_right) +")";
  else
    {
      res += "(";
  ...
  else
    {
      ...
      switch (root->_type)
        ...
        case eFORALL:
          l = expand (root->_left, k);
          r = expand (root->_right, k);
          res = create_operation (eFORALL, l, r);
          delete res2;
          delete l;
          delete r;
          break;
        case eEXISTS:
          l = expand (root->_left, k);
          r = expand (root->_right, k);
          res = create_operation (eEXISTS, l, r);
          delete res2;
          delete l;
          delete r;
          break;
  ...
  if (root->_var != NULL)
  ...
  else
    {
      ...
      switch (root->_type)
        ...
        case eFORALL:
          r = nnf (root->_right);
          res = create_operation (eFORALL, root->_left, r);
          break;
        case eEXISTS:
          r = nnf (root->_right);
          res = create_operation (eEXISTS, root->_left, r);
          break;
        default:
